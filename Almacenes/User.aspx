    ...
    <div class="fondo">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="btn-group btn-shadow">
                                ...
                                <asp:LinkButton CssClass="btn btn-primary btn-border" runat="server" ID="AddRegistroBtn" data-toggle="modal" data-target="#addModal" ToolTip="Agregar usuario">
                                <div class="form-row">
                                <asp:Label  Text="Agregar usuario" CssClass="btn-label d-none  d-xl-block d-lg-block" runat="server"></asp:Label> 
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                        <a class="dropdown-item" href="/User.aspx?PageSize=10" runat="server">10</a>
                                        <a class="dropdown-item" href="/User.aspx?PageSize=20" runat="server">20</a>
                                        <a class="dropdown-item" href="/User.aspx?PageSize=30" runat="server">30</a>
                                        <a class="dropdown-item" href="/User.aspx?PageSize=50" runat="server">50</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container-fluid">
            <div class="row pie" style="padding-left: 15px">
                <asp:DataPager ID="UserDataPager" runat="server" PagedControlID="UserListView" PageSize="10">
                    <Fields>
