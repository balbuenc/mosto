...
namespace Almacenes
{
    public partial class rptKuDE: System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                parameters[0] = new ReportParameter("id", Request.QueryString["Id"]);
                ...
                ReportViewer1.ServerReport.ReportPath = "/AlmacenesSSRS/FacturaDTE";
